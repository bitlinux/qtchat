...
FriendListWidget::FriendListWidget(IMMainWidget *mainWidget, QWidget *parent) :
...
Description:  添加
*************************************************/
void FriendListWidget::addItem(QWidget *item)
{
...
Description: 创建右键菜单
*************************************************/
void FriendListWidget:: creatMenu()
{
...
Description:  显示右键菜单
*************************************************/
void FriendListWidget::showMenu()
 {
    if (m_menu == NULL)
    {
        //创建右键菜单

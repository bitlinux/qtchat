...
QT_MOC_LITERAL(3, 25, 7), // "Tmpinfo"
QT_MOC_LITERAL(4, 33, 3), // "tmp"
QT_MOC_LITERAL(5, 37, 12), // "deletesignal"
QT_MOC_LITERAL(6, 50, 4), // "int&"
QT_MOC_LITERAL(7, 55, 2), // "id"
QT_MOC_LITERAL(8, 58, 14), // "receivemessage"
QT_MOC_LITERAL(9, 73, 12) // "deletesocket"

    },
    "ClientSocket\0sendsignal\0\0Tmpinfo\0tmp\0"
    "deletesignal\0int&\0id\0receivemessage\0"
    "deletesocket"
};
...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendsignal((*reinterpret_cast< const Tmpinfo(*)>(_a[1]))); break;
        case 1: _t->deletesignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->receivemessage(); break;
        case 3: _t->deletesocket(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ClientSocket::*)(const Tmpinfo & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientSocket::sendsignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientSocket::deletesignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClientSocket::sendsignal(const Tmpinfo & _t1)
{
...
// SIGNAL 1
void ClientSocket::deletesignal(int & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
